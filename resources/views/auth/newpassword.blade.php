                    ...
                    <div class="row flex-grow">
                        ...
                        <div class=" d-flex align-items-center justify-content-center">
                            <div class="auth-form-transparent text-left p-3 login-box ">
                                ...
                                <form class="pt-3" action="/forgotpasswordpost" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control form-control-lg border-left-0"
                                                id="exampleInputPassword" placeholder="รหัสผ่านใหม่" name="password" maxlength="6" minlength="6"
                                                required
                                    ...
                                    <div class="my-3">
                                        <input type="submit" value="แก้ไขรหัสผ่าน"
