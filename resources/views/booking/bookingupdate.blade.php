            ...
            <div class="card-body">
                ...
                <form class="forms-sample"  action="/bookingupdate" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="roomnameInput" name="bookingAgenda" placeholder="ห้องการประชุม" value="{{$booking->bookingAgenda}}">
                    </div>
                    <div class="form-group">
                        <label for="roomnameInput">วันที่ใช้ห้อง</label>
                        <input type="date" class="form-control" id="roomnameInput" name="bookingDate" value="{{$booking->bookingDate}}" >
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row" id="time">
                            <div class="col-sm-6">
                                ...
                                <input type="time" class="form-control" id="timestart" name="bookingTimeStart" value="{{$booking->bookingTimeStart}}">
                            </div>
                            <div class="col-sm-6">
                                <label for="timeend">เวลาสิ้นสุด</label>
                                <input type="time" class="form-control" id="timeend" name="bookingTimeFinish" value="{{$booking->bookingTimeFinish}}">
                            </div>
                        </div>
